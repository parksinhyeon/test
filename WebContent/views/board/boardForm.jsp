	                        ...
	                        <tr>
	                            ...
	                            <td>
	                                <div class="input-file">
	                                    ...
	                                    <input type="file" name="" id="upload01" class="file-upload" name="fileUpload" />
	                                </div>
	                            </td>
	                        </tr>
	                    </thead>
	                        ...
	                        <tr>
	                            <td colspan="2">
	                                <div class="board_content_outer">
	                                    <textarea name="" id="board_contentarea" name="contentArea"></textarea>
	                                </div>
	                            </td>
	                        </tr>
	                    </tbody>
	                        ...
	                        <tr>
	                            <td colspan="2">
	                                <div class="board_form_btn">
	                                    <button type="submit" name="formSubmit">등록 </button>
	                                    <button type="reset" name="formReset">취소</button>
	                                </div>
	                            </td>
	                        </tr>
	                    </tfoot>
